<x-app-layout title="{{ __('Mes Colocations') }}" header="{{ __('Mes Colocations') }}">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        @forelse($colocations as $colocation)
            <!-- Colocation Card -->
            <div class="bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300 border border-gray-200 overflow-hidden">
                <!-- Card Header -->
                ...
                <div class="text-center py-12 px-4 bg-white rounded-xl border-2 border-dashed border-gray-300">
                    ...
                    <div class="mx-auto w-24 h-24 bg-gray-100 rounded-full flex items-center justify-center mb-4">
                        <svg class="w-12 h-12 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19 21H5a2 2 0 01-2-2V5a2 2 0 012-2h11l5 5v11a2 2 0 01-2 2z M17 21v-4H7v4 M12 7v6 M9 10h6"/>
                        </svg>
                    </div>
