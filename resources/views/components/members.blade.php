        ...
        <div class="flex items-center justify-between px-2">
            <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="colocation-tabs"
                ...
                <li class="mr-2" role="presentation">
                    <button class="inline-block p-4 border-b-2 rounded-t-lg" id="members-tab" data-tabs-target="#members"
                        type="button" role="tab" aria-controls="members" aria-selected="true">
    ...
    <div id="colocation-tabs-content">
        <div class="p-5" id="members" role="tabpanel" aria-labelledby="members-tab">
            @if ($colocation)
                @forelse($colocation->members->where('pivot.left_at', null) as $member)
                    <div
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            @else
                                @if ($colocation->is_owner && $member->id !== auth()->id() && $colocation->is_active)
                                    <form
                                        ...
                                        <button type="submit" title="{{ __('Rendre propriétaire') }}"
                                            ...
                                            <svg class="w-3 h-3" xmlns="http://www.w3.org/2000/svg" width="1em"
                ...
                @if ($colocation->is_owner && $colocation->is_active)
                    <div class="mt-4">
